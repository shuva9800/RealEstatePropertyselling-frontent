...
export default function UpdateListing() {
    ...
    useEffect(()=>{
        const fetchListing = async ()=>{
            const response = await axios.get(`${baseUrl}/listing/get/${listingId}`,{withCredentials: true})
      ...
      const submitHandler = async (event)=>{
        ...
        try{
          ...
          if(+formData.regularPrice < +formData.discountPrice){
            ...
            setLoading(true);
            setError(null);
            const response = await axios.post(`${baseUrl}/listing/update/${listingId}`, formData, {withCredentials:true});
            const data = response.data;
            setLoading(false);
            if(data.success === false){
              setError(data.error)
